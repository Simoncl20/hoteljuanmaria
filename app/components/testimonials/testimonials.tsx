            ...
            <div className="mb-16" style={{animationDelay: '400ms'}}>
              ...
              <div className="relative max-w-5xl mx-auto px-16">
                {featuredTestimonials.length > 0 && (
                  <>
                    {/* Navigation Arrows - Outside the testimonial component */}
                    <button
                      onClick={prevSlide}
                    ...
                    <div className="relative bg-white/10 backdrop-blur-2xl rounded-2xl shadow-2xl border border-white/20 overflow-hidden p-8 md:p-12 h-[500px] flex flex-col">
                      ...
                      <div className="relative z-10 flex-grow flex flex-col justify-between">
                        <div className="flex-grow flex flex-col justify-center">
                          <blockquote className="font-sans text-lg md:text-xl text-white/95 leading-relaxed mb-8 overflow-hidden display-webkit-box webkit-line-clamp-4 webkit-box-orient-vertical">
            ...
            <div className="mb-16" style={{animationDelay: '600ms'}}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {highlights.map((highlight, index) => (
                  <div
                    key={index}
                    className="relative bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transition-all duration-700 hover:scale-105 hover:-translate-y-1 hover:shadow-xl p-6 group"
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center h-16">
                      <div className="w-3 h-3 bg-gradient-to-br from-gray-500 via-gray-400 to-gray-600 rounded-full mr-3 flex-shrink-0"/>
                      <span className="font-sans text-gray-800 font-medium">{highlight}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div style={{animationDelay: '1000ms'}}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                <div
                  key={testimonial.id}
                  className="relative bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transition-all duration-700 hover:scale-105 hover:-translate-y-2 hover:shadow-xl p-6 group h-80 flex flex-col"
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <blockquote className="font-sans text-gray-700 mb-4 flex-grow line-clamp-4 text-sm leading-relaxed">
                      "{testimonial.comment}"
                    </blockquote>
