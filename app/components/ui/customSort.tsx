...
const CustomSortSelect: React.FC<CustomSortSelectProps> = ({
  ...
  const sortOptions: SortOption[] = [
    { value: 'price-asc', label: 'Precio: Menor a Mayor', description: 'Ordenar por precio ascendente' },
    { value: 'price-desc', label: 'Precio: Mayor a Menor', description: 'Ordenar por precio descendente' },
    { value: 'capacity', label: 'Capacidad', description: 'Ordenar por número de huéspedes' },
    { value: 'size', label: 'Tamaño', description: 'Ordenar por área o superficie' },
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (event: MouseEvent) => {
      if (isOpen) {
        ...
        if (buttonRef.current && !buttonRef.current.contains(target) && !target.closest('[data-dropdown-content]')) {
          setIsOpen(false);
        }
      }
    };
