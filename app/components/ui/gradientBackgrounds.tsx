...
export const PremiumGradient: React.FC<PremiumGradientProps> = ({
  ...
  return (
    <div className={`bg-gradient-to-r from-gray-900 via-gray-800 to-black ${roundedClasses[rounded]} ${className}`}>
      {children}
    </div>
  );
};
...
export const SoftGradient: React.FC<PremiumGradientProps> = ({
  ...
  return (
    <div className={`bg-gradient-to-r from-gray-700 via-gray-600 to-gray-800 ${roundedClasses[rounded]} ${className}`}>
      {children}
    </div>
  );
};
...
export const InverseGradient: React.FC<PremiumGradientProps> = ({
  ...
  return (
    <div className={`bg-gradient-to-r from-black via-gray-800 to-gray-900 ${roundedClasses[rounded]} ${className}`}>
      {children}
    </div>
  );
};
...
export const PremiumSection: React.FC<PremiumSectionProps> = ({
  ...
  return (
    <PremiumGradient className={`${paddingClasses[padding]} ${textClasses[textColor]} relative overflow-hidden ${className}`}>
      {children}
