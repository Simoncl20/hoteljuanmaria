    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center pt-20">
      <div className="relative">
        ...
        <div className="relative bg-white/70 backdrop-blur-2xl rounded-xl shadow-2xl border border-white/20 p-12 overflow-hidden">
          ...
          <div className="absolute -bottom-8 -right-8 w-24 h-24 bg-gray-200/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '0.5s'}}></div>
          ...
          <div className="relative z-10 flex flex-col items-center space-y-6">
            ...
            <div className="relative">
              ...
              <div className="w-16 h-16 border-4 border-gray-200/30 rounded-full animate-spin">
                <div className="absolute inset-0 border-4 border-transparent border-t-gray-600 rounded-full animate-spin" style={{animationDuration: '1s'}}></div>
              </div>
              
              {/* Anillo intermedio */}
              <div className="absolute inset-2 w-12 h-12 border-3 border-gray-300/20 rounded-full animate-spin" style={{animationDirection: 'reverse', animationDuration: '1.5s'}}>
                <div className="absolute inset-0 border-3 border-transparent border-r-gray-700 rounded-full animate-spin" style={{animationDirection: 'reverse', animationDuration: '1.5s'}}></div>
              </div>
          ...
          <div className="absolute inset-0 opacity-60">
            ...
            <div className="absolute bottom-4 left-6 w-4 h-0.5 bg-gradient-to-r from-transparent via-gray-300/50 to-transparent animate-pulse" style={{animationDelay: '0.5s'}}></div>
            <div className="absolute top-8 left-8 w-2 h-2 bg-white/20 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
            <div className="absolute bottom-8 right-8 w-1 h-1 bg-gray-400/30 rounded-full animate-pulse" style={{animationDelay: '1.5s'}}></div>
          </div>
