...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses = "relative font-semibold rounded-lg overflow-hidden transition-all duration-700 group disabled:opacity-50 disabled:cursor-not-allowed";
  ...
  const content = (
    <>
      ...
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
        ...
        <div className="absolute bottom-1 left-3 w-2 h-0.5 bg-gradient-to-r from-transparent via-white/20 to-transparent animate-pulse" style={{ animationDelay: '0.3s' }}></div>
      </div>
    </>
  );
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
        ...
        <div className="absolute top-4 right-4 w-3 h-0.5 bg-gradient-to-r from-transparent via-gray-400 to-transparent animate-pulse" style={{ animationDelay: '0.3s' }}></div>
        <div className="absolute bottom-2 left-6 w-2 h-2 bg-gradient-to-br from-gray-200 via-gray-300 to-transparent rotate-12 animate-pulse" style={{ animationDelay: '0.7s' }}></div>
      </div>
