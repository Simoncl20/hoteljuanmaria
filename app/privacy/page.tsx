...
const PrivacyPolicyPage: React.FC = () => {
  ...
  const getIconForSection = (title: string) => {
    if (title.includes("Información") || title.includes("Recopilamos")) return <FileText className="w-6 h-6" />;
    if (title.includes("Finalidad") || title.includes("Tratamiento")) return <Eye className="w-6 h-6" />;
    if (title.includes("Principios")) return <Shield className="w-6 h-6" />;
    if (title.includes("Protección") || title.includes("Seguridad")) return <Lock className="w-6 h-6" />;
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center">
        <div className="relative bg-white/10 backdrop-blur-2xl border border-white/20 shadow-2xl rounded-xl p-8">
          <div className="animate-pulse flex items-center gap-4">
            ...
            <span className="text-white/70 font-sans text-lg">Cargando política de privacidad...</span>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-3/4 right-1/4 w-48 h-48 bg-white/3 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}} />
        <div className="absolute bottom-1/4 left-1/3 w-24 h-24 bg-white/4 rounded-full blur-3xl animate-pulse" style={{animationDelay: '4s'}} />
      </div>
        ...
        <div className="text-center mb-16 transform transition-all duration-1000 translate-y-0 opacity-100">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg px-4 py-2 text-white/80">
            ...
            <span className="font-sans text-sm font-medium">
              Última actualización: {new Date(policyData.lastUpdated).toLocaleDateString('es-ES', { 
                year: 'numeric', 
                month: 'long', 
                day: 'numeric' 
              })}
          ...
          <div className="p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-sans text-sm font-medium text-gray-600">Email</p>
                  <p className="font-sans text-base text-gray-900">datos@hoteljuanmaria.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-sans text-sm font-medium text-gray-600">Teléfono</p>
                  <p className="font-sans text-base text-gray-900">(2) 224-4562</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-gray-50/60 rounded-lg">
              <p className="font-sans text-sm text-gray-600">
                <strong>Horario de Atención:</strong> Lunes a viernes 8:00 AM - 6:00 PM, Sábados 8:00 AM - 12:00 PM
              </p>
            </div>
          </div>
